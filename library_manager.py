...
def remove_book(library):
      title = input("Enter the title book to rempve from the library: ")
...
def display_statistics(library):
       ...
       parcentage_read = (read_books / total_books) * 100 if total_books > 0 else 0   

       print(f"Total books: {total_books}")
       print(f"Percentage of books read: {parcentage_read:.2f}%")    
